...
class ExtensionService:
    ...
    def generate_answer(resume_markdown: str, job_description: str, question: str) -> str:
        """
        Generates a tailored answer to a job application question based on the candidate's resume and the job description.

        Args:
            resume_markdown (str): The full resume of the candidate formatted in Markdown.
            job_description (str): The description of the job the candidate is applying for.
            question (str): The specific application question to be answered.

        Returns:
            str: A concise, context-aware answer generated by the LLM.
        """
